...
public class f2_plan {
    ...
    public void getdatafromfile() throws IOException {
        ...
        // try {
        filehotels = new File("E:\\Конструктор путешествий\\Конструктор путешествий (программа на Java)\\cities\\Paris\\hotelsofparis.txt");
        filemuseums = new File("E:\\Конструктор путешествий\\Конструктор путешествий (программа на Java)\\cities\\Paris\\museumsofparis.txt");
        filetheatres = new File("E:\\Конструктор путешествий\\Конструктор путешествий (программа на Java)\\cities\\Paris\\theatresofparis.txt");
        filepriceticketsofplanes=new File("E:\\Конструктор путешествий\\Конструктор путешествий (программа на Java)\\cities\\Paris\\planesticketpriceofparis.txt");
        ...
        if (field_city.getValue() == "Берлин") {
            ...
            try {
                filehotels = new File("E:\\Конструктор путешествий\\Конструктор путешествий (программа на Java)\\cities\\Rome\\hotelsofrome.txt");
                filemuseums = new File("E:\\Конструктор путешествий\\Конструктор путешествий (программа на Java)\\cities\\Rome\\museumsofrome.txt");
                filetheatres = new File("E:\\Конструктор путешествий\\Конструктор путешествий (программа на Java)\\cities\\Rome\\theatresofrome.txt");
                filepriceticketsofplanes=new File("E:\\Конструктор путешествий\\Конструктор путешествий (программа на Java)\\cities\\Rome\\planesticketpriceofrome.txt");
            } catch (Exception e) {
                System.out.println("Файл не найден");
            }
        }
